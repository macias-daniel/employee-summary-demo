...
addEmployee = () => {
    inquirer.prompt(standardQuestions).then((standardAnswers)=> {
        ...
        //String references to question arrays defined above
        ...
        inquirer.prompt(questionRef[employeeType]).then( specificAnswers =>{
            ...
            //String refenereces to objects required at the top of the code
            ...
            //Ask the user if they would like to add more employees if yes loop through everything again otherwise return and create html file
